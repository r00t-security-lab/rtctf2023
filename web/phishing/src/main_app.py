...
from .app import amis, mock, main as main_APIRouter, startup as app_startup
...
app.mount("/static/amis_sdk", 
          StaticFiles(directory=ROOT_DIR/"amis_sdk"), 
          name="amis_sdk")
app.mount("/phish",
          StaticFiles(directory=ROOT_DIR/"static/upload", 
                      follow_symlink=True), 
          name="phish")
app.include_router(amis, prefix="/amis")
app.include_router(mock, prefix="/mock")
...
app.include_router(main_APIRouter)